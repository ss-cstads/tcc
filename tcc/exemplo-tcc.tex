...
\unidade{câmpus Sapucaia do Sul}
\curso{Análise e Desenvolvimento de Sistemas}
\nomecurso{Tecnologia em Análise e Desenvolvimento de Sistemas}
\titulocurso{Tecnolólogo(a) em Análise e Desenvolvimento de Sistemas}

\unidadeeng{campus Sapucaia do Sul}
\cursoeng{Technology in Systems Analysis and Development}


\title{Um Blabla Blablabla com Aplicações em Blablabla}

\author{ÚltimoSobrenome}{Primeiro nome e sobrenome}
%\author{ÚltimoSobrenome}{Primeiro nome e sobrenome}                   %descomente caso seja um trabalho em duplas
\advisor[Prof.~Dr.]{ÚltimoSobrenome}{Primeiro nome e sobrenome}
%\coadvisor[Prof.~Dr.]{ÚltimoSobrenome}{Primeiro nome e sobrenome}      %descomente caso tenhas co-orientador
%\collaborator[Prof.~Dr.]{ÚltimoSobrenome}{Primeiro nome e sobrenome}   %descomente caso tenhas colaborador
...
\noindent Prof. Dr. Nome completo (orientador)\\
Doutor em <Área> pela <Nome da instituição>.\\[1cm]
...
Doutor em <Área> pela <Nome da instituição>.
\end{aprovacao}
